...
<div className="mb-3">
  ...
  <div className="mb-3">
    <label htmlFor="reactions" className="form-label">Enter number of reactions</label>
    <input type="text" ref={reactionsElement} className="form-control" id="reactions" placeholder="Number of reactions"/>
  </div>
  <div className="mb-3">
